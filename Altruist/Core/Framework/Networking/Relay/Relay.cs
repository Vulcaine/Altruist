...
//     private IRelayPacketService _relayPacketService;
...
//         string protocol,
//         string host, int port, string eventName,
// IRelayPacketService relayPacketService,
//         ICodec codec, ILoggerFactory loggerFactory, ITransportClient transportClient)
//     {
//         _gatewayUrl = $"{protocol}://{host}:{port}";
//         _eventName = eventName;
//         _codec = codec;
//         _relayPacketService = relayPacketService;
...
//                 await _relayPacketService.Relay(message);
//             }
//             catch (Exception ex)
//             {
