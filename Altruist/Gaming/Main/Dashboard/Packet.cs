...
/// <summary>
/// Packet that carries the snapshot of all non-terrain objects in a world.
/// JSON + MessagePack compatible.
/// </summary>
[MessagePackObject]
public struct DashboardWorldObjectStatePacket : IPacketBase
{
    ...
    [Key(2)]
    public IReadOnlyList<DashboardWorldObjectStateDto> Objects { get; set; }

    public DashboardWorldObjectStatePacket(
        int worldIndex,
        DateTime timestampUtc,
        IReadOnlyList<DashboardWorldObjectStateDto> objects)
    {
